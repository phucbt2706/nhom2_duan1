              ...
              , E = function() {
                ...
                i = [{
                    ...
                    value: function() {
                        ...
                        "system" === this.settings.stylesOpt ? window.matchMedia("(prefers-color-scheme: dark)").matches ? (this.settings.style = "dark",
                        document.cookie = "style=dark") : (this.settings.style = "light",
                        document.cookie = "style=light") : (document.cookie = "style=; expires=Thu, 01 Jan 2000 00:00:00 UTC; path=/;",
