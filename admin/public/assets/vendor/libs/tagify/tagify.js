                ...
                t.exports = function() {
                    ...
                    var O = {
                        ...
                        createListHTML(t) {
                            return g([], t).map(((t,i)=>{
                                ...
                                return s = "string" == typeof s ? d(s) : s,
                                ...
                                if (!this.state.composing && e.userInput) {
                                    ...
                                    "mix" == e.mode) {
                                        ...
                                        case "Backspace":
                                            ...
                                            var d, h, g, p = this.getTagElms(), c = 1 === s.anchorNode.length && s.anchorNode.nodeValue == String.fromCharCode(8203);
                                            if ("edit" == e.backspace && r)
                                                return d = 1 == s.anchorNode.nodeType ? null : s.anchorNode.previousElementSibling,
                                                setTimeout(this.editTag.bind(this), 0, d),
                                                void t.preventDefault();
                                            if (u() && r instanceof Element)
                                                return g = l(r),
                                                r.hasAttribute("readonly") || r.remove(),
                                                this.DOM.input.focus(),
                                                void setTimeout((()=>{
                                                    w(g),
                                            ...
                                            if ("BR" == s.anchorNode.nodeName)
                                                return;
                                            if ((a || r) && 1 == s.anchorNode.nodeType ? h = 0 == s.anchorOffset ? a ? p[0] : null : p[Math.min(p.length, s.anchorOffset) - 1] : a ? h = s.anchorNode.nextElementSibling : r instanceof Element && (h = r),
                                            ...
                                            if ("Range" != s.type && h && h.hasAttribute("readonly"))
                                                return void w(l(h));
                                            "Delete" == t.key && c && T(s.anchorNode.nextSibling) && this.removeTags(s.anchorNode.nextSibling),
                                            clearTimeout(M),
                                            M = setTimeout((()=>{
                    ...
                    return _.prototype = {
                        ...
                        onEditTagDone(t, e) {
                            ...
                            this.settings.a11y.focusableTags ? t.focus() : w(t)) : t && this.removeTags(t),
