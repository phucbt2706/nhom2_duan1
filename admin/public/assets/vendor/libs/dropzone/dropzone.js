                        ...
                        return function() {
                            ...
                            var u = {
                                ...
                                fallback: function() {
                                    ...
                                    e || (e = m.createElement('<div class="dz-message"><span></span></div>'),
                                ...
                                addedfile: function(e) {
                                    ...
                                    this.previewsContainer && !this.options.disablePreviews) {
                                        e.previewElement = m.createElement(this.options.previewTemplate.trim()),
                                        ...
                                        try {
                                            for (u.s(); !(a = u.n()).done; )
                                                (i = a.value).innerHTML = this.filesize(e.size)
                                        } catch (e) {
                                            u.e(e)
                                        } finally {
                                            u.f()
                                        }
                                        this.options.addRemoveLinks && (e._removeLink = m.createElement('<a class="dz-remove" href="javascript:undefined;" data-dz-remove>'.concat(this.options.dictRemoveFile, "</a>")),
                                        e.previewElement.appendChild(e._removeLink));
                                        var s, l = function(n) {
                                            return n.preventDefault(),
                                            n.stopPropagation(),
                                            e.status === m.UPLOADING ? m.confirm(t.options.dictCancelUploadConfirmation, (function() {
                            ...
                            var m = function(e) {
                                ...
                                function o(e, t) {
                                    ...
                                    o.instances.push(y(n)),
                                    n.element.dropzone = y(n);
                                    var s = null != (a = o.optionsForElement(n.element)) ? a : {};
                                    if (n.options = o.extend({}, u, s, null != t ? t : {}),
                                    n.options.previewTemplate = n.options.previewTemplate.replace(/\n*/g, ""),
                                    n.options.forceFallback || !o.isBrowserSupported())
                                        return v(n, n.options.fallback.call(y(n)));
                                    ...
                                    !1 !== n.options.previewsContainer && (n.options.previewsContainer ? n.previewsContainer = o.getElement(n.options.previewsContainer, "previewsContainer") : n.previewsContainer = n.element),
                                    n.options.clickable && (!0 === n.options.clickable ? n.clickableElements = [n.element] : n.clickableElements = o.getElements(n.options.clickable, "clickable")),
                                    n.init(),
                                    n
                                }
                                return h(o, [{
                                    ...
                                    value: function() {
                                        ...
                                        this.clickableElements.forEach((function(t) {
                                            return e.listeners.push({
                                                ...
                                                events: {
                                                    click: function(n) {
                                                        return (t !== e.element || n.target === e.element || o.elementInside(n.target, e.element.querySelector(".dz-message"))) && e.hiddenFileInput.click(),
                                                        !0
                                                    }
                                                }
                                            })
                                    ...
                                    value: function() {
                                        ...
                                        return "FORM" !== this.element.tagName ? (t = o.createElement('<form action="'.concat(this.options.url, '" enctype="multipart/form-data" method="').concat(this.options.method, '"></form>'))).appendChild(r) : (this.element.setAttribute("enctype", "multipart/form-data"),
                                    ...
                                    value: function(e, t, n, r, i) {
                                        ...
                                        return this.createThumbnail(e, t, n, r, !0, (function(t, n) {
                                            ...
                                            return "image/jpeg" !== r && "image/jpg" !== r || (u = E.restore(e.dataURL, u)),
                                            i(o.dataURItoBlob(u))
                                        }
                                        ))
                                    }
                                    ...
                                    value: function(e, t) {
                                        ...
                                        for (var f in this.options.headers && o.extend(c, this.options.headers),
                                        c) {
                                            var p = c[f];
                                        ...
                                        if (this.options.params) {
                                            ...
                                            for (var v in "function" == typeof d && (d = d.call(this, e, i, e[0].upload.chunked ? this._getChunk(e[0], i) : null)),
                                            d) {
                                                var y = d[v];
                                                if (Array.isArray(y))
                                        ...
                                        this.options.uploadMultiple && this.emit("sendingmultiple", e, i, h),
                            ...
                            ,
                            m.blockedBrowsers = [/opera.*(Macintosh|Windows Phone).*version\/12/i],
                            m.isBrowserSupported = function() {
                                var e = !0;
                            ...
                            E.initClass(),
                            m._autoDiscoverFunction = function() {
                                if (m.autoDiscover)
                                    return m.discover()
                            }
                            ,
                            ...
                            }(window, m._autoDiscoverFunction),
                            window.Dropzone = m;
                            var k = m
                        }(),
                        r
