!function(t, e) {
    ...
    return function() {
                    ...
                    !function(e) {
                        ...
                        function m() {
                            ...
                            this._initBody = function(t) {
                                var e;
                                this._bodyInit = t,
                                t ? "string" == typeof t ? this._bodyText = t : i && Blob.prototype.isPrototypeOf(t) ? this._bodyBlob = t : r && FormData.prototype.isPrototypeOf(t) ? this._bodyFormData = t : n && URLSearchParams.prototype.isPrototypeOf(t) ? this._bodyText = t.toString() : s && i && (e = t) && DataView.prototype.isPrototypeOf(e) ? (this._bodyArrayBuffer = y(t.buffer),
                                this._bodyInit = new Blob([this._bodyArrayBuffer])) : s && (ArrayBuffer.prototype.isPrototypeOf(t) || l(t)) ? this._bodyArrayBuffer = y(t) : this._bodyText = t = Object.prototype.toString.call(t) : this._bodyText = "",
                        ...
                        function b(t, e) {
                            ...
                            this.method = (o = (n = e.method || this.method || "GET").toUpperCase(),
                            v.indexOf(o) > -1 ? o : n),
        ...
        function i(t) {
            ...
            return n[t].call(r.exports, r, r.exports, i),
            r.exports
        }
        ...
        i.t = function(n, o) {
            ...
            var s = {};
            t = t || [null, e({}), e([]), e(e)];
            for (var a = 2 & o && n; "object" == typeof a && !~t.indexOf(a); a = e(a))
        ...
        return function() {
            ...
            class e {
                ...
                forward(t, e, n, o) {
                    return o && !this.debug ? null : ("string" == typeof t[0] && (t[0] = `${n}${this.prefix} ${t[0]}`),
                    this.logger[e](t))
                }
                create(t) {
            ...
            function p(t, e, n) {
                for (const o in e)
                    "__proto__" !== o && "constructor" !== o && (o in t ? "string" == typeof t[o] || t[o]instanceof String || "string" == typeof e[o] || e[o]instanceof String ? n && (t[o] = e[o]) : p(t[o], e[o], n) : t[o] = e[o]);
                return t
            }
            function h(t) {
                return t.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&")
            ...
            function y(t, e) {
                ...
                for (let t = 0; t < o.length; ++t) {
                    if (!i)
                        return;
                    if ("string" == typeof i[o[t]] && t + 1 < o.length)
                        return;
                    if (void 0 === i[o[t]]) {
                        let r = 2
            ...
            class x extends o {
                ...
                extractFromKey(t, e) {
                    ...
                    if (r && !s) {
                        ...
                        const r = t.split(n);
                        (n !== o || n === o && this.options.ns.indexOf(r[0]) > -1) && (i = r.shift()),
                        t = r.join(o)
                    }
                ...
                translate(t, e, n) {
                    ...
                    const o = void 0 !== e.returnDetails ? e.returnDetails : this.options.returnDetails
                      ...
                      , {key: r, namespaces: s} = this.extractFromKey(t[t.length - 1], e)
                      , a = s[s.length - 1]
                    ...
                    if (y && p && "string" != typeof p && "boolean" != typeof p && "number" != typeof p && ["[object Number]", "[object Function]", "[object RegExp]"].indexOf(d) < 0 && ("string" != typeof g || "[object Array]" !== d)) {
                        ...
                        p = p.join(g),
                        p && (p = this.extendTranslation(p, t, e, n));
                    else {
                        let o = !1
                          , s = !1;
                        ...
                        if (s || o || m) {
                            if (this.logger.log(m ? "updateKey" : "missingKey", l, a, r, m ? g : p),
                            i) {
                            ...
                            const o = (t,n,o)=>{
                                const i = h && o !== p ? o : y;
                                this.options.missingKeyHandler ? this.options.missingKeyHandler(t, a, n, i, m, e) : this.backendConnector && this.backendConnector.saveMissing && this.backendConnector.saveMissing(t, a, n, i, m, e),
                        ...
                        s && p === r && this.options.appendNamespaceToMissingKey && (p = `${a}:${r}`),
                        (s || o) && this.options.parseMissingKeyHandler && (p = "v1" !== this.options.compatibilityAPI ? this.options.parseMissingKeyHandler(this.options.appendNamespaceToMissingKey ? `${a}:${r}` : r, o ? p : void 0) : this.options.parseMissingKeyHandler(p))
                    }
                    return o ? (c.res = p,
                    c) : p
                }
                    ...
                    if (this.i18nFormat && this.i18nFormat.parse)
                        ...
                        !1 !== n.nest && (t = this.interpolator.nest(t, (function() {
                            for (var t = arguments.length, o = new Array(t), s = 0; s < t; s++)
                                o[s] = arguments[s];
                            return i && i[0] === o[0] && !n.context ? (r.logger.warn(`It seems you are nesting recursively key: ${o[0]} in key: ${e[0]}`),
                            null) : r.translate(...o, e)
                        }
                        ), n)),
                ...
                resolve(t) {
                    ...
                    t.forEach((t=>{
                        ...
                        u.forEach((t=>{
                            this.isValidLookup(e) || (r = t,
                            !w[`${f[0]}-${t}`] && this.utils && this.utils.hasLoadedNamespace && !this.utils.hasLoadedNamespace(r) && (w[`${f[0]}-${t}`] = !0,
                            ...
                            f.forEach((n=>{
                                ...
                                if (this.i18nFormat && this.i18nFormat.addLookupKeys)
                                    ...
                                    if (c && (r.push(l + t),
                                    s.ordinal && 0 === t.indexOf(o) && r.push(l + t.replace(o, this.options.pluralSeparator)),
                                    p && r.push(l + e)),
                                    h) {
                                        const n = `${l}${this.options.contextSeparator}${s.context}`;
                                        r.push(n),
                                        c && (r.push(n + t),
                                        s.ordinal && 0 === t.indexOf(o) && r.push(n + t.replace(o, this.options.pluralSeparator)),
                                        p && r.push(n + e))
                                    }
                                }
                                let a;
                                for (; a = r.pop(); )
                                    this.isValidLookup(e) || (o = a,
                                    e = this.getResource(n, t, a, s))
                            }
                            )))
                        }
                        ))
            ...
            class E {
                constructor(t) {
                    ...
                    this.options.compatibilityJSON && !R.includes(this.options.compatibilityJSON) || "undefined" != typeof Intl && Intl.PluralRules || (this.options.compatibilityJSON = "v3",
            ...
            function N(t, e, n) {
                ...
                return !r && i && "string" == typeof n && (r = y(t, n, o),
                void 0 === r && (r = y(e, n, o))),
                r
            }
            class C {
                    ...
                    return [{
                        ...
                        for (s = 0; i = e.regex.exec(t); ) {
                            ...
                            void 0 === r)
                                ...
                                "string" == typeof r || this.useRawValueToEscape || (r = a(r));
                            const l = e.safeValue(r);
                            if (t = t.replace(i[0], l),
                            h ? (e.regex.lastIndex += r.length,
                ...
                nest(t, e) {
                    ...
                    for (; n = this.nestingRegexp.exec(t); ) {
                        ...
                        if (o = e(s.call(this, n[1].trim(), i), i),
                        o && n[0] === t && "string" != typeof o)
                            return o;
                        "string" != typeof o && (o = a(o)),
                        o || (this.logger.warn(`missed to resolve ${n[1]} for nesting ${t}`),
                        o = ""),
                        u && (o = l.reduce(((t,e)=>this.format(t, e, r.lng, {
                            ...r,
            ...
            class A extends o {
                constructor(t, e, o) {
                    ...
                    this.state = {},
                    this.queue = [],
                    this.backend && this.backend.init && this.backend.init(o, i.backend, i)
                }
                queueLoad(t, e, n, o) {
                    const i = {}
                      , r = {}
                    ...
                    return t.forEach((t=>{
                        ...
                        e.forEach((e=>{
                            const s = `${t}|${e}`;
                            !n.reload && this.store.hasResourceBundle(t, e) ? this.state[s] = 2 : this.state[s] < 0 || (1 === this.state[s] ? void 0 === r[s] && (r[s] = !0) : (this.state[s] = 1,
                            o = !1,
                            void 0 === r[s] && (r[s] = !0),
                            void 0 === i[s] && (i[s] = !0),
                            void 0 === a[e] && (a[e] = !0)))
                ...
                loadOne(t) {
                    ...
                    this.read(o, i, "read", void 0, void 0, ((n,r)=>{
                        n && this.logger.warn(`${e}loading namespace ${i} for language ${o} failed`, n),
                        !n && r && this.logger.log(`${e}loaded namespace ${i} for language ${o}`, r),
                        this.loaded(t, n, r)
                    }
                    ))
                }
                        ...
                        if (this.backend && this.backend.create) {
                            ...
                            if (l.length < 6)
                                try {
                                    ...
                                    i && "function" == typeof i.then ? i.then((t=>s(null, t))).catch(s) : s(null, i)
                                } catch (t) {
                                    s(t)
                                }
                            else
            ...
            class U extends o {
                ...
                init() {
                    ...
                    !this.options.isClone) {
                        ...
                        this.modules.formatter ? e = this.modules.formatter : "undefined" != typeof Intl && (e = $);
                        ...
                        !e || this.options.interpolation.format && this.options.interpolation.format !== i.interpolation.format || (s.formatter = r(e),
                        ...
                        s.backendConnector = new A(r(this.modules.backend),s.resourceStore,s,this.options),
                ...
                loadResources(t) {
                    ...
                    !this.options.resources || this.options.partialBundledLanguages) {
                        ...
                        ;
                        n ? o(n) : this.services.languageUtils.getFallbackCodes(this.options.fallbackLng).forEach((t=>o(t))),
                        this.options.preload && this.options.preload.forEach((t=>o(t))),
                ...
                getFixedT(t, e, n) {
                    ...
                    const i = function(t, e) {
                        ...
                        let c;
                        return c = r.keyPrefix && Array.isArray(t) ? t.map((t=>`${r.keyPrefix}${u}${t}`)) : r.keyPrefix ? `${r.keyPrefix}${u}${t}` : t,
                        o.t(c, r)
                    };
                ...
                cloneInstance() {
                    ...
                    n && (i.store = new v(this.store.data,o),
            ...
            "function" == typeof fetch && (J = "undefined" != typeof global && global.fetch ? global.fetch : "undefined" != typeof window && window.fetch ? window.fetch : fetch),
            K() && ("undefined" != typeof global && global.XMLHttpRequest ? z = global.XMLHttpRequest : "undefined" != typeof window && window.XMLHttpRequest && (z = window.XMLHttpRequest)),
            "function" == typeof ActiveXObject && ("undefined" != typeof global && global.ActiveXObject ? X = global.ActiveXObject : "undefined" != typeof window && window.ActiveXObject && (X = window.ActiveXObject)),
            J || !W || z || X || (J = G || W),
            ...
            var Q = function(t, e) {
              ...
              , et = function(t, e, n, o) {
                ...
                o = o || function() {}
                ,
                J && 0 !== e.indexOf("file:") ? function(t, e, n, o) {
                    ...
                    try {
                        ...
                        if (!r || 0 === Object.keys(r).length || !t.message || t.message.indexOf("not implemented") < 0)
                            return o(t);
                        try {
                    ...
                    try {
                        var i;
                        (i = z ? new z : new X("MSXML2.XMLHTTP.3.0")).open(n ? "POST" : "GET", e, 1),
            ...
            var rt = function() {
                ...
                n = [{
                    ...
                    value: function(t, e, n, o, i) {
                        var r, s = this, a = this.options.loadPath;
                        "function" == typeof this.options.loadPath && (a = this.options.loadPath(t, n)),
                        (a = function(t) {
                    ...
                    value: function(t, e, n, o) {
                        ...
                        this.options.request(this.options, t, a, (function(r, s) {
                            ...
                            if (!s && r && r.message && r.message.indexOf("Failed to fetch") > -1)
                            ...
                            s.forEach((function(e) {
                                t.allOptions.ns.forEach((function(t) {
                                    n.read(e, t, "read", null, null, (function(o, r) {
                                        o && i.warn("loading namespace ".concat(t, " for language ").concat(e, " failed"), o),
                                        !o && r && i.log("loaded namespace ".concat(t, " for language ").concat(e), r),
