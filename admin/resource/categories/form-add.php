                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col"><label class="form-label">Category Name</label>
                                <input type="text" class="form-control <?= !empty($error['error_name_cate']) ? 'border border-danger' : false ?>" value="<?= !empty($_POST['cate_name']) ? $_POST['cate_name'] : false ?>" name="cate_name">
                        ...
                        <div class="mb-3 col ecommerce-select2-dropdown" data-select2-id="15">
                            ...
                            <select id="vendor" name="parent_id" class="select2 form-select ">
                                ...
                                <?php
                                    ...
                                    <option  value=<?= $item['cate_id'] ?>><?= $item['cate_id']." - ".$item['cate_name'] ?></option>
                                    <?php
                                    }
                                ?>
                                </select>
